# @lucacome's Karabiner Elements configuration
...
1. Create a symlink with `ln -s ~/github/lucacome/karabiner ~/.config` (where `~/github/lucacome/karabiner` is your local path to where you cloned the repository)
